...
//    	Transaction tnx = session.beginTransaction();
//    	
//    	Query q = session.createNamedQuery("whr");
////    	Query q = session.createQuery
...
//    }
    static void selectWhere()
    {
    	...
    	Query q = session.createNamedQuery("whar");
//    	Query q = session.createQuery
//    		("from Product where price >=:pr1 and price<=:pr2");
...
//    	Transaction tnx = session.beginTransaction();
//    	
//    	Query q = session.createNamedQuery("allpd");
//    	List<Product>lst = q.getResultList();
//    	for (Product product : lst) {
//			System.out.println(product);
//		}
...
//    }
    static void selectAll()
    {
    	...
    	Query q = session.createNamedQuery("selall");
    	List<Product>lst = q.getResultList();
    	for (Product product : lst) {
			System.out.println(product);
		}
