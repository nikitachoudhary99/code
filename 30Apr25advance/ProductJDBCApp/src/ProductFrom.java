...
public class ProductFrom extends JFrame implements ActionListener 
{
	...
	public ProductFrom() {
		...
		b7 = new JButton("List Of All Products");
	...
	public static void main(String[] args) 
	{
		...
		ProductFrom clc = new ProductFrom();
		clc.setVisible(true);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource()==b2)
		{
			if(db.updateProduct(p))
				t2.setText("Product Updated");
			else
				t2.setText("Product Not Updated");	
		}
		if(e.getSource()==b3)
		{
			if(db.deleteProduct(p))
				t2.setText("Product Deleted");
			else
