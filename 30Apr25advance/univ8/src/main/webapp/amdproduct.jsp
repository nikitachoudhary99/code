          ...
          <div class="card-body">
            ...
            <form class="form-signin" action="AMDProductServlet" method="post">
              <div class="form-label-group">
                <input type="text"email" id="inputEmail" class="form-control" placeholder="Product Id" name="pid" required autofocus>
              ...
              <div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" placeholder="Price" name="price" required autofocus>
