...
/*when there is a base class and derived class 
the capability of class to derived properties and charactersticsfrom another class is called inheritence 
types of inheritence->>
1> single inheritence
2>multiple inheritence
3>multi level inheritence
4>herical inheritence
